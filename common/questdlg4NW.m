function ButtonName=questdlg(Question,Title,Btn1,Btn2,Btn3,Btn4,Default) % NW
...
elseif NumButtons==4 % NW
    BtnXOffset=[MsgTxtXOffset
        0
        0
        FigPos(3)-DefOffset-BtnWidth];
    BtnXOffset(2) = (BtnXOffset(1)+BtnXOffset(3))/2 - BtnWidth/2;
    BtnXOffset(3) = (BtnXOffset(1)+BtnXOffset(3))/2 + BtnWidth/2;
end
...
elseif NumButtons==4 % NW
    BtnXMiddle = (FigPos(3)-BtnWidth)/2;
    BtnXOffset=[BtnXMiddle-1.5*DefOffset-1.5*BtnWidth
        BtnXMiddle-0.5*DefOffset-0.5*BtnWidth
        BtnXMiddle+0.5*DefOffset+0.5*BtnWidth
        BtnXMiddle+1.5*DefOffset+1.5*BtnWidth
        ];
end
