...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
 ...
 /* function fmap = getB0correctedCESTmap(ppm,ppmlist,posimages,negimages,B0map,mask,b0ppmstep) */
    ...
    mwSize i1, i2, i3, nzppm, ninterp, nppmout,ninterp2;
    ...
    ninterp = 1 + ( (nzppm-1)*stepppm/interp_ppmstep );
    ninterp2 = ninterp/2;
    ...
    for (ielem = 0; ielem < nelem; ielem++) 
    {
        ...
        {            
            ...
            i2 = (ppmpos/interp_ppmstep) + ninterp2;
            zsp2p= interpzs[i2];
            
            i2 = (ppmneg/interp_ppmstep) + ninterp2;
            zsp2n= interpzs[i2];
